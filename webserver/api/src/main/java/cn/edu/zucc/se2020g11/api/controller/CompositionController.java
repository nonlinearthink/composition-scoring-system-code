...
public class CompositionController {
    ...
    public CompositionController(RedisMessageMqService messageMqService, CompositionService compositionService, SupportService supportService, FavoriteService favoriteService, CommentService commentService, PermissionService permissionService, FollowService followService, ErrorService errorService, HistoryService historyService) {
    ...
    @ApiImplicitParam(paramType = "path", name = "compositionId", value = "文章ID", required = true, dataType = "Integer")
    public ResponseEntity<ApiResult<Map<String, Object>>> selectCompositionByTourist(@PathVariable("compositionId") Integer compositionId) {
        CompositionCountModel compositionCountModel = compositionService.selectCountByCompositionId(compositionId);
        List<CommentEntity> commentEntityList = commentService.selectComment(compositionId);
        ApiResult<Map<String, Object>> result = new ApiResult<>();
        result.setMsg("获取成功");
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "body", name = "compositionEntity", value = "文章", required = true, dataType =
                    "CompositionEntity"),
            @ApiImplicitParam(paramType = "query", name = "username", value = "用户名", required = true, dataType =
                    "String")
    })
    public ResponseEntity<ApiResult<Map<String, Object>>> addComposition(@RequestBody CompositionEntity compositionEntity, HttpServletRequest request) {
        ...
        if(compositionEntity.getStatus()==finished){
    ...
    public ResponseEntity<ApiResult<Boolean>> deleteComposition(@PathVariable("compositionId") Integer compositionId, HttpServletRequest request) {
        ...
        historyService.deleteHistoryByCompositionId(compositionId);
