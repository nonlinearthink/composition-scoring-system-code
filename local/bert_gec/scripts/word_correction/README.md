# word correction with edit distance
this original code come from  https://github.com/fanorfan/EnglishWordErrorCorrection

we refactored it and used for our system.

the word copora consist of three parts:

- Gutenberg copora
- wiki dictionary
- the most common used words in England country
