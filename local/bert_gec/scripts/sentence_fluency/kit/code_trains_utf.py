...
def handleEncoding(original_file, newfile):
    ''' this function is used to transfer file to utf-8 format
    :param original_file: the original file which has encoding problem
    :param newfile: the target file shich has been transfer to utf-8 format
    '''
